...
def roll_the_dice(dice_code):
    ...
    :param str dice_code: dice pattern ex. '5D10+15'
    :rtype: int, str
    :return: dice roll value for dice pattern, "Wrong Input" text elsewhere
    """
